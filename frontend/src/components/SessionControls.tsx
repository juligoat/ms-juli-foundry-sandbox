...
const hoverIn = (e: React.MouseEvent<HTMLButtonElement>) => {
  e.currentTarget.style.color = "var(--colorNeutralForeground1, #242424)";
};
const hoverOut = (e: React.MouseEvent<HTMLButtonElement>) => {
  e.currentTarget.style.color = "var(--colorNeutralForeground2, #424242)";
};
const activeIn = (e: React.MouseEvent<HTMLButtonElement>) => {
  e.currentTarget.style.transform = "scale(0.92)";
};
const activeOut = (e: React.MouseEvent<HTMLButtonElement>) => {
