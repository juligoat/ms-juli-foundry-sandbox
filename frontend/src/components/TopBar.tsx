      ...
      {showControls && (
        <div style={rightStyle}>
          ...
          <Menu>
            ...
            <MenuPopover>
              <MenuList>
                <MenuItem icon={<Settings24Regular />} onClick={() => onOpenSettings()}>
                  Settings
                </MenuItem>
                <MenuItem
                  icon={<TextAlignLeftRegular />}
                  onClick={() => window.open("https://aka.ms/aistudio/terms", "_blank")}
                >
                  Terms of use <Open16Regular style={{ marginLeft: "4px", opacity: 0.6 }} />
                </MenuItem>
                <MenuItem
                  icon={<ShieldRegular />}
                  onClick={() => window.open("https://go.microsoft.com/fwlink/?linkid=521839", "_blank")}
                >
                  Privacy <Open16Regular style={{ marginLeft: "4px", opacity: 0.6 }} />
                </MenuItem>
